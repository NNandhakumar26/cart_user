...
class ToyInfoScreen extends StatefulWidget {
  ...
  @override
  _ToyInfoScreenState createState() => _ToyInfoScreenState();
}

class _ToyInfoScreenState extends State<ToyInfoScreen>
          ...
          builder: (_) {
            return Stack(
              children: <Widget>[
                ...
                //   Positioned(
                //     top: (MediaQuery.of(context).size.width / 1.2) - 24.0 + 100,
                //     right: 35,
                //     child: InkWell(
                //       onTap: () {
                //         _.wishListFunction(widget.listData!);
